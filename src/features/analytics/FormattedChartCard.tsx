...
import { classNames, formatDate } from '../../functions'
...
export default function FormattedChartCard({
  header,
  subheader,
  figure,
  format = (value) => value,
  ...
  return (
    <div className="w-full p-5 space-y-4 font-bold border border-dark-900 rounded shadow-md bg-[rgba(0,0,0,0.12)]">
      <div className="flex justify-between">
        ...
        <div>
          <div className="flex justify-end text-2xl text-high-emphesis">{format(overrideFigure)}</div>
